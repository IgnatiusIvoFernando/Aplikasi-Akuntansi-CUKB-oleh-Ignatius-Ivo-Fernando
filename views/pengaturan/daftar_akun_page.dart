...
class _DaftarAkunPageState extends State<DaftarAkunPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Daftar Akun', style: TextStyle(fontSize: 20, color: Colors.white)),
        leading: Builder(
                  ...
                  children: _kategoriList.map((kategori) {
                    ...
                    return Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(kategori.nama, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black87)),
                            const SizedBox(width: 10),
                            Container(
                              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                              decoration: BoxDecoration(color: Colors.grey[300], borderRadius: BorderRadius.circular(10)),
                              child: Text('${akunList.length} akun', style: const TextStyle(fontSize: 11, color: Colors.black54)),
                            ),
                          ],
                        ),
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(akun.nama, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: Colors.black87)),
                                    ),
                                    IconButton(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border(bottom: BorderSide(color: Colors.white.withAlpha(51), width: 1.5)),
                          boxShadow: [
                            BoxShadow(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.add_circle_outline, color: Colors.white.withAlpha(204), size: 24),
                              const SizedBox(width: 12),
                              const Text(
                                "Tambah Akun Baru",
                                style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Nama Akun", style: TextStyle(fontSize: 15, color: AppColors.list_period)),
                            ...
                            const SizedBox(height: 20),
                            Text("Kategori", style: TextStyle(fontSize: 15, color: AppColors.list_period)),
                            const SizedBox(height: 5),
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: const Color(0xFF3A2AD8).withAlpha(77),
                                      blurRadius: 10,
                                ...
                                child: ElevatedButton(
                                  ...
                                  child: const Text("Simpan", style: TextStyle(color: Colors.white, fontSize: 15)),
                                ),
                              ),
                            ),
                          ],
  ...
  IconData _getKategoriIcon(String kategoriNama) {
    switch (kategoriNama) {
      ...
      case "Pengeluaran": return Icons.money_off;
      case "Pemasukan": return Icons.attach_money;
  ...
  Color _getKategoriColor(String kategoriNama) {
    switch (kategoriNama) {
      case "Aset": return const Color(0xFF4CAF50);
      case "Pengeluaran": return const Color(0xFFF44336);
      case "Pemasukan": return const Color(0xFF2196F3);
